...
class CustomUserUpdateForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'postal_code' : forms.TextInput(attrs={'class': 'dotted-input w-full py-3 text-sm font-medium text-gray-900 placeholder-gray-500', 'placeholder': 'POSTAL_CODE'}),
        }
    ...
    def clean(self):
        ...
        for field in ['company', 'address1', 'address2', 'city', 'country',
            ...
            if self.cleaned_data.get(field):
                self.cleaned_data[field] = strip_tags(self.cleaned_data[field])
        return self.cleaned_data